...
namespace SymuMurphiesAndBlockers.Classes
{
    public class ExampleEnvironment : SymuEnvironment
    {
        ...
        public override void SetOrganization(OrganizationEntity organization)
        {
            ...
            organization.Templates.Human.Cognitive.TasksAndPerformance.TasksLimit.LimitSimultaneousTasks = false;
            ...
            organization.Models.FollowBlockers = true;
            organization.Models.FollowTasks = true;
            organization.Models.Learning.On = false;
