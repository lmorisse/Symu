...
namespace Symu.Repository.Entities
{
    ...
    public class WikiEntity : Database
    {
        ...
        public static WikiEntity CreateInstance(MetaNetwork metaNetwork, OrganizationModels models)
        {
            return new WikiEntity(metaNetwork, models);
        }

        private WikiEntity(){}
        private WikiEntity(MetaNetwork metaNetwork, OrganizationModels models) : base(metaNetwork, models, new ViaPlatformTemplate(), Class)
        {
