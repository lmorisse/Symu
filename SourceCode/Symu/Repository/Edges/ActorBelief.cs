...
{
    /// <summary>
    ///     Describe the Knowledge of an actor :
    ...
    public class ActorBelief : OrgMod.Edges.ActorBelief 
    {
        ...
        /// <summary>
        ///     Check the actor beliefs against the taskKnowledges
        /// </summary>
        ...
        /// <returns>The normalized score of the actor belief [-1; 1]</returns>
        ...
        public override float CompareTo(IActorBelief other)
        {
            if (other is ActorBelief actorBelief)
            {
