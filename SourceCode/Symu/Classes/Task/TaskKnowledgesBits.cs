...
namespace Symu.Classes.Task
{
    ...
    public class TaskKnowledgesBits
    {
        ...
        public IEnumerable<IAgentId> KnowledgeIds => List.Select(x => x.KnowledgeId);
        ...
        public TaskKnowledgeBits GetBits(IAgentId knowledgeId)
        {
        ...
        /// </summary>
        /// <param name="knowledgeId"></param>
        public void RemoveFirstRequired(IAgentId knowledgeId)
        {
            var bits = GetBits(knowledgeId);
