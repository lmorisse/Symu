...
namespace SymuTools.ProbabilityDistributions
{
    ...
    public static class DiscreteUniform
    {
        ...
        {
            return Math.DiscreteUniform.Sample(lower, upper);
        }
        ...
        {
            return Convert.ToByte(Math.DiscreteUniform.Sample(lower, upper));
        }
        ...
        {
            return Math.DiscreteUniform.Sample(0, upper);
        }
        ...
        public static float[] Samples(int length, int lower, int upper)
        {
            ...
            Math.DiscreteUniform.Samples(values, lower, upper);
        ...
        {
            var values = new int[length];
            Math.DiscreteUniform.Samples(values, 0, upper);
