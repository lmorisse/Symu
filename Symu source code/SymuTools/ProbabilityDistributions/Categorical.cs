...
namespace SymuTools.ProbabilityDistributions
{
    ...
    public static class Categorical
    {
        ...
        {
            return Math.Categorical.Sample(probabilityMass);
        }
        ...
        public static double SampleValue(double[] probabilityMass)
        {
            ...
            var index = Math.Categorical.Sample(probabilityMass);
        ...
        public static float SampleValue(float[] probabilityMass)
        {
            ...
            var index = Math.Categorical.Sample(probabilityMassDouble);
            return probabilityMass[index];
        }
    }
}