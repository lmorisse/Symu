...
namespace SymuEngineTests.Repository.Networks.Knowledges
{
    ...
    public class AgentKnowledgeTests
    {
        ...
        {
            var realLearning = _agentKnowledge0.Learn(0, 1, 0);
        ...
        {
            var realLearning = _agentKnowledge0.Learn(0, 2, 0);
            Assert.AreEqual(1, _agentKnowledge0.GetKnowledgeBit(0));
            Assert.AreEqual(1, realLearning);
        }
        ...
        {
            var realForget = _agentKnowledge1.Forget(0, 1, 0);
        ...
        {
            var realForget = _agentKnowledge1.Forget(0, 2, 0);
            Assert.AreEqual(0, _agentKnowledge1.GetKnowledgeBit(0));
            Assert.AreEqual(-1, realForget);
        }
        ...
        {
            _agentKnowledge1.MinimumKnowledge = 1;
            var realForget = _agentKnowledge1.Forget(0, 1, 0);
