...
namespace SymuEngineTests.Repository.Networks.Knowledge
{
    ...
    public class KnowledgeMatrixTests
    {
        ...
        private readonly SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge _info1 =
            new SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge(1, "1", 1);

        private readonly SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge _info2 =
            new SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge(2, "2", 1);

        private readonly SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge _info3 =
            new SymuEngine.Repository.Networks.Knowledge.Repository.Knowledge(3, "3", 1);
        ...
        private void Interaction1X1()
        {
            ...
            _network.Add(_agentId1, _info1, KnowledgeLevel.Expert);
        }
        ...
        private void NoInteraction2X2()
        {
            ...
            _network.Add(_agentId2, _info2, KnowledgeLevel.Expert);
        }
        ...
        private void NoInteraction3X3()
        {
            ...
            _network.Add(_agentId3, _info3, KnowledgeLevel.Expert);
        }
        ...
        {
            NoInteraction2X2();
            _network.Add(_agentId1, _info2, KnowledgeLevel.Expert);
            _network.Add(_agentId2, _info1, KnowledgeLevel.Expert);
        ...
        public void InteractionNumberOfTriads3X3Test()
        {
            NoInteraction3X3();
            _network.Add(_agentId1, _info2, KnowledgeLevel.Expert);
            _network.Add(_agentId1, _info3, KnowledgeLevel.Expert);
            _network.Add(_agentId2, _info1, KnowledgeLevel.Expert);
            _network.Add(_agentId2, _info3, KnowledgeLevel.Expert);
            _network.Add(_agentId3, _info1, KnowledgeLevel.Expert);
            _network.Add(_agentId3, _info2, KnowledgeLevel.Expert);
            Assert.AreEqual((uint) 1, KnowledgeMatrix.NumberOfTriads(_knowledges, _actors, _network));
        }
