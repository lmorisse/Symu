...
namespace SymuEngineTests.Repository.Networks.Sphere
{
    ...
    public class InteractionSphereTests
    {
        ...
        private readonly Belief _belief = new Belief(1, 1, RandomGenerator.RandomBinary);
        ...
        {
            _network.NetworkBeliefs.Add(agentId, _belief);
        ...
        {
            AddLink();
            _model.SetInteractionPatterns(InteractionStrategy.SocialDemographics);
            InteractionSphere.SetSphere(true, _agents, _network);
