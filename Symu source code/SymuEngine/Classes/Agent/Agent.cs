...
namespace SymuEngine.Classes.Agent
{
    /// <summary>
    ...
    public abstract class Agent
    {
        ...
        ///     FIPA Norm : AID
        /// </summary>
        public virtual AgentId Id { get; set; }
        ...
        /// <summary>
        ///     Random list of AgentId part of its interaction sphere based on the interaction strategy of the interaction patterns
        ///     Filtered by the activity, the knowledgeId or the groupId
        /// </summary>
        /// <param name="groupId"></param>
        /// <param name="activity"></param>
        /// <param name="knowledgeId"></param>
        public IEnumerable<AgentId> GetAgentIdsToInteract(AgentId groupId, string activity, ushort knowledgeId)
        {
            var agentIdsToInteract = new List<AgentId>();
            IEnumerable<AgentId> teammateIds;
            switch (Cognitive.InteractionPatterns.NextInteractionStrategy())
            {
                case InteractionStrategy.Homophily:
                    // best HomophilyScore (Knowledge, beliefs, socio-demographics
                    throw new NotImplementedException();
                case InteractionStrategy.DeliberateSearch:
                    // Having the good knowledge
                    teammateIds = Environment.WhitePages.Network.GetActiveLinks(Id);
                    agentIdsToInteract.AddRange(
                        Environment.WhitePages.Network.NetworkKnowledges.FilterAgentsWithKnowledge(teammateIds,
                            knowledgeId));
                    break;
                case InteractionStrategy.CoWorkers:
                    // Working on the same activity, 
                    teammateIds = Environment.WhitePages.Network.GetActiveLinks(Id);
                    agentIdsToInteract.AddRange(
                        Environment.WhitePages.Network.NetworkActivities.FilterAgentIdsWithActivity(teammateIds,
                            groupId, activity));
                    break;
                default:
        ...
        /// <summary>
        ///     Triggered after message post in the MessageManager
        /// </summary>
        /// <param name="message"></param>
