...
namespace SymuEngine.Repository.Networks.Knowledge
{
    ...
    public static class KnowledgeMatrix
    {
        ...
        public static sbyte[,] GetMatrixKnowledge(Knowledges knowledges, IEnumerable<AgentId> actors,
        ...
        /// <param name="knowledgeNetwork"></param>
        /// <returns></returns>
        public static float[,] GetPassiveInteractionMatrix(Knowledges knowledges, IEnumerable<AgentId> actors,
            NetworkKnowledges knowledgeNetwork)
        {
            #region Null
        ...
        /// <param name="knowledgeNetwork"></param>
        /// <returns></returns>
        public static float[,] GetActiveInteractionMatrix(Knowledges knowledges, IEnumerable<AgentId> actors,
        ...
        //TODO refactor to another class
        public static uint NumberOfTriads(Knowledges knowledges, IEnumerable<AgentId> actors,
            NetworkKnowledges knowledgeNetwork)
        {
            #region Null
        ...
        public static float GetAverageInteractionMatrix(Knowledges knowledges, IEnumerable<AgentId> actors,
            NetworkKnowledges knowledgeNetwork)
        {
            #region Null
