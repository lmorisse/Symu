...
namespace SymuEngine.Repository.Networks.Belief.Agent
{
    /// <summary>
    ...
    public class AgentBelief
    {
        ...
        /// <returns></returns>
        public void InitializeBeliefBits(KnowledgeModel model, byte length, bool neutral)
        {
            if (model is null)
            {
        ...
        public float Check(byte[] taskKnowledgeIndexes, out byte index, Repository.Belief belief,
        ...
        public void Learn(KnowledgeModel model, byte beliefBit)
        {
            if (model is null)
            {
                throw new ArgumentNullException(nameof(model));
