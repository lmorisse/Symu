...
namespace SymuEngine.Repository.Networks.Belief
{
    /// <summary>
    ///     Belief network
    ...
    public class NetworkBeliefs
    {
        ...
        /// </summary>
        public Beliefs Repository { get; } = new Beliefs();
        ...
        public Repository.Belief GetBelief(ushort beliefId)
        {
        ...
        /// </summary>
        public void AddBelief(Knowledge.Repository.Knowledge knowledge)
        {
            ...
            var belief = new Repository.Belief(knowledge.Id, knowledge.Length, Model);
            if (Exists(belief))
            {
                return;
            }
        ...
        /// </summary>
        public void AddBelief(Repository.Belief belief)
        {
            if (Exists(belief))
            {
                return;
        ...
        /// </summary>
        public void AddBeliefs(IEnumerable<Knowledge.Repository.Knowledge> knowledges)
        {
        ...
        public bool Exists(Repository.Belief belief)
        {
        ...
        public void Add(AgentId agentId, Repository.Belief belief)
        {
            if (belief is null)
            {
